...
!function (e, t) {
  ...
  return function (e) {
    ...
    }(), l = o(3), c = i(l), s = o(4), d = n(s), u = o(5), v = i(u);
    o(7);
    var f = o(11), p = i(f), h = o(12), g = i(h), b = o(13), m = i(b), y = o(14), _ = i(y), w = o(15), x = i(w),
      k = o(16), C = i(k), T = o(24), O = i(T), E = o(26), S = i(E), L = o(30), j = i(L), N = o(37), P = i(N),
      M = '#__vconsole', A = function () {
        function e(t) {
          if (a(this, e), v['default'].one(M)) return void console.debug('vConsole is already exists.');
          var o = this;
          if (this.version = c['default'].version, this.$dom = null, this.isInited = !1, this.option = {defaultPlugins: ['system', 'network', 'element', 'storage']}, this.activedTab = '', this.tabList = [], this.pluginList = {}, this.switchPos = {
            x: 10,
            y: 10,
            startX: 0,
            startY: 0,
        ...
        return r(e, [{
          ...
          key: '_render', value: function () {
            ...
            var t = v['default'].one('.vc-switch', this.$dom), o = 1 * d.getStorage('switch_x'),
            ...
            var i = window.devicePixelRatio || 1, a = document.querySelector('[name="viewport"]');
            if (a && a.content) {
              var r = a.content.match(/initial\-scale\=\d+(\.\d+)?/), l = r ? parseFloat(r[0].split('=')[1]) : 1;
          ...
          key: '_mockTap', value: function () {
            var e = 700, t = 10, o = void 0, n = void 0, i = void 0, a = !1, r = null;
            this.$dom.addEventListener('touchstart', function (e) {
              ...
              if (a === !1 && t.timeStamp - o < e && null != r) {
                var n = r.tagName.toLowerCase(), i = !1;
                switch (n) {
                  case'textarea':
                    i = !0;
                    break;
                ...
                var l = t.changedTouches[0], c = document.createEvent('MouseEvents');
          ...
          key: '_bindEvent', value: function () {
            ...
            v['default'].bind(t, 'touchstart', function (t) {
              ...
              if (o.touches.length > 0) {
                var n = o.touches[0].pageX - e.switchPos.startX, i = o.touches[0].pageY - e.switchPos.startY,
                  a = e.switchPos.x - n, r = e.switchPos.y - i;
            ...
            v['default'].bind(o, 'touchstart', function (e) {
              var t = o.scrollTop, i = o.scrollHeight, a = t + o.offsetHeight;
            ...
            e.vConsole = this, e.trigger('init'), e.trigger('renderTab', function (o) {
              ...
              if (o) {
                for (var n = v['default'].one('.vc-topbar', t.$dom), i = function (t) {
                  var i = o[t], a = v['default'].render(_['default'], {
              ...
              if (o) {
                for (var n = v['default'].one('.vc-tool-last', t.$dom), i = function (t) {
                  var i = o[t], a = v['default'].render(x['default'], {name: i.name || 'Undefined', pluginID: e.id});
          ...
          key: 'setOption', value: function (e, t) {
            if (d.isString(e)) {
              this.option[e] = t, this._triggerPluginsEvent('updateOption');
    ...
    function o(e) {
      var t = e > 0 ? new Date(e) : new Date, o = t.getDate() < 10 ? '0' + t.getDate() : t.getDate(),
        n = t.getMonth() < 9 ? '0' + (t.getMonth() + 1) : t.getMonth() + 1, i = t.getFullYear(),
    ...
    function g(e) {
      var t = arguments.length <= 1 || void 0 === arguments[1] ? '	' : arguments[1],
        o = arguments.length <= 2 || void 0 === arguments[2] ? 'CIRCULAR_DEPENDECY_OBJECT' : arguments[2], n = [],
    ...
    function o(e, t, o) {
      var n = /\{\{([^\}]+)\}\}/g, i = '', a = '', r = 0, l = [], c = function (e, t) {
    ...
    function i(e) {
      for (var t = [], o = {}, n = 0; n < e.length; n++) {
        var i = e[n], a = i[0], r = i[1], l = i[2], c = i[3], s = {css: r, media: l, sourceMap: c};
    ...
    function s(e, t) {
      ...
      if (t.singleton) {
        ...
        e.sourceMap && 'function' == typeof URL && 'function' == typeof URL.createObjectURL && 'function' == typeof URL.revokeObjectURL && 'function' == typeof Blob && 'function' == typeof btoa ? (o = c(t), n = v.bind(null, o), i = function () {
    ...
    var c = function () {
      ...
      }, d = o(5), u = i(d), v = o(4), f = n(v), p = o(17), h = i(p), g = o(22), b = i(g), m = o(23), y = i(m),
      _ = function (e) {
        function t() {
          var e;
          a(this, t);
        ...
        return l(t, e), c(t, [{
          ...
          key: 'mockConsole', value: function () {
            ...
            f.isFunction(window.onerror) && (this.windowOnError = window.onerror), window.onerror = function (t, o, n, i, a) {
              ...
              var l = !!a && !!a.stack, c = l && a.stack.toString() || '';
              e.printLog({
                logType: 'error',
                logs: [r, c],
                noOrigin: !0
          ...
          key: 'evalCommand', value: function (e) {
            ...
            if (document.documentElement.removeChild(i), 0 == r) {
              ...
              this.printLog({logType: 'error', logs: [a], noMeta: !0, style: ''});
            }
          }
        }]), t;
      }(h['default']);
    ...
    var c = 'function' == typeof Symbol && 'symbol' == typeof Symbol.iterator ? function (e) {
      ...
      }(), d = o(4), u = i(d), v = o(5), f = n(v), p = o(18), h = n(p), g = o(19), b = n(g), m = o(20), y = n(m),
      _ = o(21), w = n(_), x = 1e3, k = function (e) {
        function t() {
          var e;
          a(this, t);
          for (var o = arguments.length, n = Array(o), i = 0; o > i; i++) n[i] = arguments[i];
        ...
        return l(t, e), s(t, [{
          ...
          key: 'onReady', value: function () {
            ...
            f['default'].bind(t, 'click', function (o) {
              ...
              var n = this.dataset.type, i = f['default'].one('.vc-log', e.$tabbox);
          ...
          key: 'getFoldedLine', value: function (e, t) {
            var o = this;
            if (!t) {
              var n = u.JSONStringify(e), i = n.substr(0, 26);
    ...
    var c = function () {
      ...
      var a = n.get;
      if (void 0 !== a) return a.call(o);
    }, d = o(4), u = (i(d), o(17)), v = n(u), f = o(25), p = n(f), h = function (e) {
      function t() {
        var e;
        a(this, t);
        for (var o = arguments.length, n = Array(o), i = 0; o > i; i++) n[i] = arguments[i];
      ...
      return l(t, e), c(t, [{
        ...
        key: 'printSystemInfo', value: function () {
          var e = navigator.userAgent, t = '', o = e.match(/(ipod).*\s([\d_]+)/i), n = e.match(/(ipad).*\s([\d_]+)/i),
            i = e.match(/(iphone)\sos\s([\d_]+)/i), a = e.match(/(android)\s([\d\.]+)/i);
          t = 'Unknown', a ? t = 'Android ' + a[2] : i ? t = 'iPhone, iOS ' + i[2].replace(/_/g, '.') : n ? t = 'iPad, iOS ' + n[2].replace(/_/g, '.') : o && (t = 'iPod, iOS ' + o[2].replace(/_/g, '.'));
          var r = t, l = e.match(/MicroMessenger\/([\d\.]+)/i);
    ...
    var c = function () {
      ...
      }(), s = o(5), d = i(s), u = o(4), v = n(u), f = o(18), p = i(f), h = o(27), g = i(h), b = o(28), m = i(b),
      y = o(29), _ = i(y), w = function (e) {
        function t() {
          var e;
          a(this, t);
          for (var o = arguments.length, n = Array(o), i = 0; o > i; i++) n[i] = arguments[i];
        ...
        return l(t, e), c(t, [{
          ...
          key: 'onReady', value: function () {
            ...
            e.isReady = !0, this.renderHeader(), d['default'].delegate(d['default'].one('.vc-log', this.$tabbox), 'click', '.vc-group-preview', function (t) {
              var o = this.dataset.reqid, n = this.parentNode;
          ...
          key: 'renderHeader', value: function () {
            var e = Object.keys(this.reqList).length, t = d['default'].render(m['default'], {count: e}),
          ...
          key: 'updateRequest', value: function (e, t) {
            ...
            if (this.reqList[e] = n, this.isReady) {
              ...
              var l = d['default'].render(_['default'], a), c = this.domList[e];
          ...
          key: 'mockAjax', value: function () {
            ...
            if (e) {
              ...
              t._open = o, t._send = n, window.XMLHttpRequest.prototype.open = function () {
                var e = this, n = [].slice.call(arguments), i = n[0], a = n[1], r = t.getUniqueID(), l = null;
                e._requestID = r, e._method = i, e._url = a;
                var c = e.onreadystatechange || function () {
                }, s = function () {
                  var o = t.reqList[r] || {};
                  if (o.readyState = e.readyState, o.status = 0, e.readyState > 1 && (o.status = e.status), o.responseType = e.responseType, 0 == e.readyState) {
                    ...
                    3 == e.readyState || (4 == e.readyState ? (clearInterval(l), o.endTime = +new Date, o.costTime = o.endTime - (o.startTime || o.endTime), o.response = e.response) : clearInterval(l));
                  }
    ...
    o(31);
    var s = o(18), d = i(s), u = o(33), v = i(u), f = o(34), p = i(f), h = o(4), g = (n(h), o(5)), b = i(g),
      m = function (e) {
        function t() {
          var e;
          a(this, t);
          for (var o = arguments.length, n = Array(o), i = 0; o > i; i++) n[i] = arguments[i];
          var l = r(this, (e = Object.getPrototypeOf(t)).call.apply(e, [this].concat(n))), c = l;
        ...
        return l(t, e), c(t, [{
          ...
          key: 'onAddTool', value: function (e) {
            var t = this, o = [{
              name: 'Expend', global: !1, onClick: function (e) {
                if (t.activedElem) {
          ...
          key: 'onChildRemove', value: function (e) {
            ...
            if (o) {
              for (var n = 0; n < e.removedNodes.length; n++) {
                var i = e.removedNodes[n], a = i.__vconsole_node;
          ...
          key: 'onChildAdd', value: function (e) {
            ...
            if (o) {
              ...
              for (var n = 0; n < e.addedNodes.length; n++) {
                var i = e.addedNodes[n], a = i.__vconsole_node;
                if (a) {
          ...
          key: 'renderView', value: function (e, t, o) {
            var n = this, i = new p['default'](e).get();
    ...
    var s = function () {
    ...
    }(), d = o(35), u = i(d), v = o(36), f = i(v), p = o(4), h = (n(p), o(5)), g = i(h), b = function () {
      function e(t) {
      ...
      return s(e, [{
        ...
        key: '_createElementNode', value: function (e, t) {
          var o = r(e.tagName), n = o;
          0 == e.childNodes.length && (n = !0);
          var i = g['default'].render(u['default'], {node: e}), a = g['default'].render(f['default'], {node: e});
          if (n) {
    ...
    var c = function () {
      ...
      }(), s = o(18), d = i(s), u = o(38), v = i(u), f = o(39), p = i(f), h = o(4), g = n(h), b = o(5), m = i(b),
      y = function (e) {
        function t() {
          var e;
          a(this, t);
        ...
        return l(t, e), c(t, [{
          ...
          key: 'getCookieList', value: function () {
            ...
            for (var e = [], t = document.cookie.split(';'), o = 0; o < t.length; o++) {
              var n = t[o].split('='), i = n.shift().replace(/^ /, ''), a = n.join('=');
