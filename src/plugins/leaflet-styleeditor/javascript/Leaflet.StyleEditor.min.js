var leafletstyleeditor = function (t) {
  var e = {};
  ...
  o(1), L.StyleEditor = {
    ...
    forms: {},
    formElements: {}
  }, L.Marker.include({styleEditor: {type: "Marker"}}), L.Polygon.include({styleEditor: {type: "Polygon"}}), L.Polyline.include({styleEditor: {type: "Polyline"}}), L.Rectangle.include({styleEditor: {type: "Rectangle"}}), L.StyleEditor.Util = L.Class.extend({
    initialize: function (t) {
      ...
      if (t || 0 !== (t = this.options.styleEditorOptions.defaultColor).indexOf("#") && (t = "#" + t), 0 === t.indexOf("#")) return e && t.replace("#", ""), t;
      if (t.indexOf("(") < 0) return "#" + t;
      var o = t.substring(4).replace(")", "").split(","),
        i = this._componentToHex(parseInt(o[0], 10)) + this._componentToHex(parseInt(o[1], 10)) + this._componentToHex(parseInt(o[2], 10));
      return e ? i : "#" + i
      ...
      if (o instanceof L.Marker) this.options.styleEditorOptions.markerType.setStyle(t, e); else {
        var i = {};
        i[t] = e, o.setStyle(i)
      }
      ...
      t = this.rgbToHex(t);
      var e = this.options.styleEditorOptions.markerType.options.markers, o = this.options.styleEditorOptions.markers;
      if (Array.isArray(e) || (e = Object.keys(e).includes(t) ? e[t] : e.default), null !== o) {
        if (!Array.isArray(o)) {
          var i = Object.keys(o);
      ...
      t = this.rgbToHex(t);
      var e = this.getMarkersForColor(t), o = [], i = this.options.styleEditorOptions.defaultMarkerIcon;
      return null !== i && ("string" == typeof i && o.push(i), Object.keys(i).includes(t) && o.push(i[t])), void 0 !== (i = this.options.styleEditorOptions.markerType.options.defaultMarkerIcon) && ("string" == typeof i && o.push(i), Object.keys(i).includes(t) && o.push(i[t])), o.filter((function (t) {
        return e.includes(t)
      })), o.length > 0 ? o[0] : e[0]
    }
  }), L.StyleEditor.formElements.FormElement = L.Class.extend({
    initialize: function (t) {
      t && L.setOptions(this, t), !this.options.title && this.options.styleOption && (this.options.title = this.options.styleOption.charAt(0).toUpperCase() + this.options.styleOption.slice(1))
    }, create: function (t) {
      this.options.uiElement = L.DomUtil.create("div", "leaflet-styleeditor-uiElement", t), this.createTitle(), this.createContent()
      ...
      var e = this.options.styleEditorOptions.util.getCurrentElement(), o = [e];
      e instanceof L.LayerGroup && (o = Object.values(e._layers));
      for (var i = 0; i < o.length; i++) {
        var n = o[i];
        if (n instanceof L.Marker) this.options.styleEditorOptions.markerType.setStyle(this.options.styleOption, t); else {
          var s = {};
          s[this.options.styleOption] = t, n.setStyle(s), n.options[this.options.styleOption] = t
        }
    ...
    createContent: function () {
      this.options.colorPickerDiv = L.DomUtil.create("div", "leaflet-styleeditor-colorpicker", this.options.uiElement), this._getColorRamp().forEach(this._setSelectCallback, this)
    }, _getColorRamp: function () {
      return this.options.colorRamp || (this.options.parentForm instanceof L.StyleEditor.forms.MarkerForm && this.options.styleEditorOptions.markerType.options.colorRamp ? this.options.colorRamp = this.options.styleEditorOptions.markerType.options.colorRamp : this.options.colorRamp = this.options.styleEditorOptions.colorRamp), this.options.colorRamp
    }, _setSelectCallback: function (t) {
      var e = L.DomUtil.create("div", "leaflet-styleeditor-color", this.options.colorPickerDiv);
      e.style.backgroundColor = t, L.DomEvent.addListener(e, "click", this._selectColor, this)
    }, _selectColor: function (t) {
      t.stopPropagation(), this.setStyle(this.options.styleEditorOptions.util.rgbToHex(t.target.style.backgroundColor)), this.options.styleEditorOptions.currentElement.target instanceof L.Marker && this.options.styleEditorOptions.markerType.setNewMarker()
    }
  }), L.StyleEditor.formElements.DashElement = L.StyleEditor.formElements.FormElement.extend({
    createContent: function () {
      var t = this.options.uiElement, e = L.DomUtil.create("div", "leaflet-styleeditor-stroke", t);
      e.style.backgroundPosition = "0px -75px", L.DomEvent.addListener(e, "click", (function () {
        this.setStyle("1")
      }), this), (e = L.DomUtil.create("div", "leaflet-styleeditor-stroke", t)).style.backgroundPosition = "0px -95px", L.DomEvent.addListener(e, "click", (function () {
        this.setStyle("10, 10")
      }), this), (e = L.DomUtil.create("div", "leaflet-styleeditor-stroke", t)).style.backgroundPosition = "0px -115px", L.DomEvent.addListener(e, "click", (function () {
    ...
    createContent: function () {
      var t = this.options.uiElement, e = L.DomUtil.create("div", "leaflet-styleeditor-select", t);
      this.options.selectBoxImage = this._createSelectInputImage(e), L.DomEvent.addListener(e, "click", this._toggleSelectInput, this)
    },
    style: function () {
      var t = this.options.styleEditorOptions.markerType.getIconOptions();
      this._styleSelectInputImage(this.options.selectBoxImage, t.icon, t.iconColor), this._createColorSelect(this.options.styleEditorOptions.markerType.options.iconOptions.iconColor), this._hideSelectOptions()
    },
    lostFocus: function () {
    ...
    _styleSelectInputImage: function (t, e, o) {
      if (e || (e = t.getAttribute("value"))) {
        ...
        o && (i.iconColor = o), t.innerHTML = "", this.options.styleEditorOptions.markerType.createSelectHTML(t, i, e), t.setAttribute("value", e)
      }
    },
    _createColorSelect: function (t) {
      if (this.options.selectOptions || (this.options.selectOptions = {}), !(t in this.options.selectOptions)) {
        var e = this.options.uiElement, o = L.DomUtil.create("ul", this._selectOptionWrapperClasses, e);
        this.options.styleEditorOptions.util.getMarkersForColor(t).forEach((function (e) {
          var i = L.DomUtil.create("li", this._selectOptionClasses, o), n = this._createSelectInputImage(i);
          this._styleSelectInputImage(n, e, t)
        }), this), this.options.selectOptions[t] = o, L.DomEvent.addListener(o, "click", (function (t) {
          t.stopPropagation();
          var e = t.target;
          if ("UL" !== e.nodeName) {
            if ("leaflet-styleeditor-select-image" === e.parentNode.className) e = e.parentNode; else for (; e && "leaflet-styleeditor-select-image" !== e.className;) e = e.childNodes[0];
    ...
    _toggleSelectInput: function (t) {
      var e = this._getCurrentColorElement(this.options.styleEditorOptions.util.rgbToHex(this.options.styleEditorOptions.markerType.options.iconOptions.iconColor)),
        o = !1;
      e && (o = L.DomUtil.hasClass(e, "leaflet-styleeditor-hidden")), this._hideSelectOptions(), o && this.options.styleEditorOptions.util.showElement(e)
    },
    _selectMarker: function (t) {
      var e = this._getValue(t.target);
      this.options.selectBoxImage.setAttribute("value", e), this.setStyle(e), this._hideSelectOptions()
    },
    _getValue: function (t) {
      return t.getAttribute("value")
    },
    _getCurrentColorElement: function (t) {
      return this.options.selectOptions[t] || this._createColorSelect(t), this.options.selectOptions[t]
    },
    _hideSelectOptions: function () {
      for (var t in this.options.selectOptions) this.options.styleEditorOptions.util.hideElement(this.options.selectOptions[t])
    }
    ...
    createContent: function () {
      ...
      t.type = "range", t.max = 1, t.min = 0, t.step = .01, t.value = .5, L.DomEvent.addListener(t, "change", this._setStyle, this), L.DomEvent.addListener(t, "input", this._setStyle, this), L.DomEvent.addListener(t, "keyup", this._setStyle, this), L.DomEvent.addListener(t, "mouseup", this._setStyle, this)
    }, style: function () {
      this.options.slider.value = this.options.styleEditorOptions.util.getStyle(this.options.styleOption), this.options.label.innerText = parseInt(100 * this.options.slider.value) + "%"
    }, _setStyle: function () {
    ...
    _setStyle: function () {
      var t = this.options.styleEditorOptions.util.getCurrentElement(), e = this.options.descTextAreaField.value,
        o = [t];
      t instanceof L.LayerGroup && (o = Object.values(t._layers));
      for (var i = 0; i < o.length; i++) {
        var n = o[i];
        if (n && n.getPopup && n.bindPopup) {
          var s = n.getPopup();
          s ? s.setContent(e) : n.bindPopup(e), n.options = n.options || {}, n.options.popupContent = e
        }
      }
      this.setStyle(e)
    }
    ...
    createContent: function () {
      var t = this.options.uiElement, e = L.DomUtil.create("div", "leaflet-styleeditor-sizeicon sizeicon-small", t);
      L.DomEvent.addListener(e, "click", (function () {
        this.setStyle(this.options.styleEditorOptions.markerType.options.size.small)
      }), this), e = L.DomUtil.create("div", "leaflet-styleeditor-sizeicon sizeicon-medium", t), L.DomEvent.addListener(e, "click", (function () {
        this.setStyle(this.options.styleEditorOptions.markerType.options.size.medium)
      }), this), e = L.DomUtil.create("div", "leaflet-styleeditor-sizeicon sizeicon-large", t), L.DomEvent.addListener(e, "click", (function () {
    ...
    createContent: function () {
      ...
      t.type = "range", t.min = 0, t.max = 20, t.step = 1, t.value = 4, L.DomEvent.addListener(t, "change", this._setStyle, this), L.DomEvent.addListener(t, "input", this._setStyle, this), L.DomEvent.addListener(t, "keyup", this._setStyle, this), L.DomEvent.addListener(t, "mouseup", this._setStyle, this)
    }, style: function () {
      this.options.weight.value = this.options.styleEditorOptions.util.getStyle(this.options.styleOption), this.options.label.innerText = this.options.weight.value
    }, _setStyle: function () {
    ...
    initialize: function (t) {
      ...
      for (var e = this.getFormElements(), o = Object.keys(e), i = 0; i < o.length; i++) {
        var n = this.getFormElementClass(o[i], e);
        void 0 !== n && (n.create(t), this.options.initializedElements.push(n))
      }
    }, hide: function () {
      this.hideFormElements(), this.hideForm()
    }, hideFormElements: function () {
      for (var t = 0; t < this.options.initializedElements.length; t++) this.options.initializedElements[t].hide()
    }, hideForm: function () {
      this.options.styleEditorOptions.util.hideElement(this.options.parentUiElement)
    }, show: function () {
      this.preShow(), this.showFormElements(), this.showForm(), this.style()
    }, preShow: function () {
    }, showFormElements: function () {
      for (var t = 0; t < this.options.initializedElements.length; t++) this.showFormElement(this.options.initializedElements[t])
    }, showForm: function () {
      this.options.styleEditorOptions.util.showElement(this.options.parentUiElement)
    }, style: function () {
      for (var t = 0; t < this.options.initializedElements.length; t++) this.options.initializedElements[t].style()
    }, lostFocus: function () {
      for (var t = 0; t < this.options.initializedElements.length; t++) this.options.initializedElements[t].lostFocus()
      ...
      if (Object.keys(e).indexOf(t) >= 0) {
        var o = e[t];
        if (o) {
          if ("boolean" == typeof o) return this.getFormElementStandardClass(t);
          "formElement" in o && "boolean" in o && (o = o.formElement);
          try {
            var i = new o({styleOption: t, parentForm: this, styleEditorOptions: this.options.styleEditorOptions});
            if (i instanceof L.StyleEditor.formElements.FormElement) return i
          } catch (t) {
          }
        }
      ...
      if (t in e) {
        ...
        if ("function" == typeof o) try {
          return o(this.options.styleEditorOptions.util.getCurrentElement())
        } catch (t) {
          return !0
        }
        return "boolean" == typeof o ? o : !("boolean" in o) || ("function" == typeof o.boolean ? o.boolean(this.options.styleEditorOptions.util.getCurrentElement()) : o.boolean)
      }
      return !1
    ...
    initialize: function (t) {
      L.setOptions(this, t), L.setOptions(this, this.options), "" === this.options.selectIconClass || this.options.selectIconClass.startsWith("leaflet-styleeditor-select-image") || (this.options.selectIconClass = "leaflet-styleeditor-select-image-" + this.options.selectIconClass)
    },
    setNewMarker: function () {
      var t = this._createMarkerIcon(), e = this.options.styleEditorOptions.currentElement.target;
      e.setIcon(t), e instanceof L.LayerGroup ? e.eachLayer((function (t) {
    ...
    setStyle: function (t, e) {
      "icon" !== t && (t = "icon" + t.charAt(0).toUpperCase() + t.slice(1)), this.setIconOptions(t, e), this.setNewMarker()
    },
    ...
    _ensureMarkerIcon: function (t) {
      return this.options.styleEditorOptions.util.getMarkersForColor(t.iconColor).includes(t.icon) ? t : (t.icon = this.options.styleEditorOptions.util.getDefaultMarkerForColor(t.iconColor), t)
    },
    _getDefaultMarkerColor: function () {
      var t = this.options.colorRamp, e = this.options.styleEditorOptions.colorRamp, o = [];
      null != t ? 0 === (o = t.filter((function (t) {
        return e.includes(t)
      }))).length && (o = t) : o = e;
      var i = this.options.styleEditorOptions.defaultMarkerColor;
      return null === i || o.includes(i) || (i = null), null === i && (null === (i = this.options.styleEditorOptions.defaultColor) || o.includes(i) || (i = null), null === i && (i = o[0])), this.options.styleEditorOptions.util.rgbToHex(i)
    },
    sizeToName: function (t) {
      var e = Object.keys(this.options.size);
      if ("string" == typeof t) {
        "s" === t ? t = "small" : "m" === t ? t = "medium" : "l" === t && (t = "large");
        for (var o = 0; o < e.length; o++) if (this.options.size[e[o]] === t) return e[o]
      }
      for (var i = Object.values(this.options.size), n = 0; n < i.length; n++) if (JSON.stringify(t) === JSON.stringify(i[n])) return e[n];
      return e[0]
    },
    ...
    createMarkerIcon: function (t, e) {
      ...
      var i = {};
      i.iconSize = this.options.size.small, i.icon = o, i.iconColor = e.iconColor, t.innerHTML = this.createMarkerIcon(i, this.options.selectIconClass).createIcon().outerHTML
    }, _getMarkerUrlForStyle: function (t) {
      return this._getMarkerUrl(t.iconSize, t.iconColor, t.icon)
    }, _getMarkerUrl: function (t, e, o) {
      var i = "https://api.tiles.mapbox.com/v3/marker/pin-" + (t = this.sizeToName(t)[0]);
      return o && (i += "-" + o), i + "+" + (e = 0 === e.indexOf("#") ? e.replace("#", "") : this.options.styleEditorOptions.util.rgbToHex(e, !0)) + ".png"
    }, options: {
    ...
    getMarkerHtml: function (t, e, o) {
      ...
      return '<div class="leaflet-styleeditor-marker leaflet-styleeditor-marker-' + this.sizeToName(t)[0] + '" style="background-image: url(' + i + ');"><div class="leaflet-styleeditor-fill"></div><i class="glyphicon ' + o + '"></i><div class="leaflet-styleeditor-fill"></div></div>'
    ...
    initialize: function (t) {
      L.setOptions(this, t), this.createMarkerForm(), this.createGeometryForm(), this.addDOMEvents()
    }, addDOMEvents: function () {
      L.DomEvent.addListener(this.options.styleEditorOptions.map, "click", this.lostFocus, this), L.DomEvent.addListener(this.options.styleEditorDiv, "click", this.lostFocus, this)
    }, clearForm: function () {
      this.options.styleEditorOptions.markerForm.hide(), this.options.styleEditorOptions.geometryForm.hide()
      ...
      for (var e = t.target, o = 0; o < 10 && e; o++) {
        if (e.className && L.DomUtil.hasClass(e, "leaflet-styleeditor-interior")) return;
        e = e.parentNode
      }
      this.options.styleEditorOptions.markerForm.lostFocus(), this.options.styleEditorOptions.geometryForm.lostFocus()
    }
    ...
    options: {
      ...
      t && L.setOptions(this, t), this.options.util = new L.StyleEditor.Util({styleEditorOptions: this.options}), this.options.markerType = new this.options.markerType({styleEditorOptions: this.options}), this.options.markerForm = new this.options.markerType.markerForm({styleEditorOptions: this.options}), this.options.geometryForm = new this.options.geometryForm({styleEditorOptions: this.options}), this.getDefaultIcon = this.options.markerType._createMarkerIcon.bind(this.options.markerType), this.createIcon = this.options.markerType.createMarkerIcon.bind(this.options.markerType)
    }, onAdd: function (t) {
      ...
      (this.options.controlUI = L.DomUtil.create("a", "leaflet-control-styleeditor-interior", t)).title = "Style Editor";
      var e = this.options.cancelUI = L.DomUtil.create("div", "leaflet-control-styleeditor-cancel leaflet-styleeditor-hidden", t);
      e.innerHTML = this.options.strings.cancel, e.title = this.options.strings.cancelTitle;
      var o = this.options.styleEditorDiv = L.DomUtil.create("div", "leaflet-styleeditor", this.options.map._container);
      this.options.styleEditorHeader = L.DomUtil.create("div", "leaflet-styleeditor-header", o);
      var i = L.DomUtil.create("div", "leaflet-styleeditor-interior", o);
      return this.addDomEvents(), this.addEventListeners(), this.addButtons(), this.options.styleForm = new L.StyleForm({
        styleEditorDiv: o,
        styleEditorInterior: i,
        styleEditorOptions: this.options
      }), t
    }, addDomEvents: function () {
      L.DomEvent.disableScrollPropagation(this.options.styleEditorDiv), L.DomEvent.disableScrollPropagation(this.options.controlDiv), L.DomEvent.disableScrollPropagation(this.options.cancelUI), L.DomEvent.disableClickPropagation(this.options.styleEditorDiv), L.DomEvent.disableClickPropagation(this.options.controlDiv), L.DomEvent.disableClickPropagation(this.options.cancelUI), L.DomEvent.on(this.options.controlDiv, "click", (function () {
        this.toggle()
      }), this)
    }, addEventListeners: function () {
      this.addLeafletDrawEvents(), this.addLeafletEditableEvents()
    }, addLeafletDrawEvents: function () {
      this.options.openOnLeafletDraw && L.Control.Draw && (this.options.map.on("layeradd", this.onLayerAdd, this), this.options.map.on(L.Draw.Event.CREATED, this.onLayerCreated, this))
    }, addLeafletEditableEvents: function () {
      this.options.openOnLeafletEditable && L.Editable && (this.options.map.on("layeradd", this.onLayerAdd, this), this.options.map.on("editable:created", this.onLayerCreated, this))
    }, onLayerCreated: function (t) {
      this.removeIndicators(), this.options.currentElement = t.layer
    }, onLayerAdd: function (t) {
      this.options.currentElement && t.layer === this.options.util.getCurrentElement() && this.enable(t.layer)
    }, onRemove: function () {
      this.disable(), this.removeDomEvents(), this.removeEventListeners(), L.DomUtil.remove(this.options.styleEditorDiv), L.DomUtil.remove(this.options.cancelUI), delete this.options.styleEditorDiv, delete this.options.cancelUI
    }, removeEventListeners: function () {
      this.options.map.off("layeradd", this.onLayerAdd), L.Draw && this.options.map.off(L.Draw.Event.CREATED, this.onLayerCreated), L.Editable && this.options.map.off("editable:created", this.onLayerCreated)
      ...
      t.title = this.options.strings.tooltipNext, L.DomEvent.on(t, "click", (function (t) {
        this.hideEditor(), L.DomUtil.hasClass(this.options.controlUI, "enabled") && this.createTooltip(), t.stopPropagation()
      }), this)
    }, toggle: function () {
      L.DomUtil.hasClass(this.options.controlUI, "enabled") ? this.disable() : this.enable()
    }, enable: function (t) {
      this._layerIsIgnored(t) || (L.DomUtil.addClass(this.options.controlUI, "enabled"), this.options.map.eachLayer(this.addEditClickEvents, this), this.showCancelButton(), this.createTooltip(), void 0 !== t && (this.isEnabled() && this.removeIndicators(), this.initChangeStyle({target: t})))
    }, isEnabled: function () {
      return L.DomUtil.hasClass(this.options.controlUI, "enabled")
    }, disable: function () {
      this.isEnabled() && (this.options._editLayers.forEach(this.removeEditClickEvents, this), this.options._editLayers = [], this.options._layerGroups = [], this.hideEditor(), this.hideCancelButton(), this.removeTooltip(), L.DomUtil.removeClass(this.options.controlUI, "enabled"))
    }, addEditClickEvents: function (t) {
      if (!this._layerIsIgnored(t)) if (this.options.useGrouping && t instanceof L.LayerGroup) this.options._layerGroups.push(t); else if (t instanceof L.Marker || t instanceof L.Path) {
      ...
      L.DomUtil.hasClass(this.options.styleEditorDiv, "editor-enabled") && (this.removeIndicators(), L.DomUtil.removeClass(this.options.styleEditorDiv, "editor-enabled"), this.fireEvent("hidden"))
    }, hideCancelButton: function () {
      L.DomUtil.addClass(this.options.cancelUI, "leaflet-styleeditor-hidden")
    }, showEditor: function () {
      var t = this.options.styleEditorDiv;
      L.DomUtil.hasClass(t, "editor-enabled") || (L.DomUtil.addClass(t, "editor-enabled"), this.fireEvent("visible"))
    }, showCancelButton: function () {
      L.DomUtil.removeClass(this.options.cancelUI, "leaflet-styleeditor-hidden")
    }, initChangeStyle: function (t) {
      this.removeIndicators(), this.options.currentElement = this.options.useGrouping ? this.getMatchingElement(t) : t, this.addIndicators(), this.showEditor(), this.removeTooltip();
      var e = t;
      e instanceof L.Layer || (e = t.target), this.fireEvent("editing", e), e instanceof L.Marker ? (this.options.markerType.resetIconOptions(), this.showMarkerForm(e)) : this.showGeometryForm(e)
    }, showGeometryForm: function (t) {
      this.fireEvent("geometry", t), this.options.styleForm.showGeometryForm()
    }, showMarkerForm: function (t) {
      this.fireEvent("marker", t), this.options.styleForm.showMarkerForm()
    }, createTooltip: function () {
      this.options.showTooltip && (this.options.tooltipWrapper || (this.options.tooltipWrapper = L.DomUtil.create("div", "leaflet-styleeditor-tooltip-wrapper", this.options.map.getContainer())), this.options.tooltip || (this.options.tooltip = L.DomUtil.create("div", "leaflet-styleeditor-tooltip", this.options.tooltipWrapper)), this.options.tooltip.innerHTML = this.options.strings.tooltip)
    }, getMatchingElement: function (t) {
      for (var e = null, o = t.target, i = 0; i < this.options._layerGroups.length; ++i) if ((e = this.options._layerGroups[i]) && o !== e && e.hasLayer(o)) return e.options && e.options.opacity || (e.options = o.options, o.setIcon && (e.setIcon = function (t) {
      ...
      this.options.tooltip && this.options.tooltip.parentNode && (this.options.tooltip.remove(), this.options.tooltip = void 0)
    ...
    return t || (t = {}), new L.Control.StyleEditor(t)
  };
  e.default = L
}]);
