...
!function (t) {
  ...
  L.Control.BrowserPrint.Size = {
    ...
    if (this.PageSeries) {
      var t = L.Control.BrowserPrint.Size[this.PageSeries], e = t.Width, r = t.Height, n = !1;
    ...
    var t = this.getPaperSize(), e = parseInt(this.getPageMargin()), r = function (t) {
      return e ? t - 2 * e : t
    };
  ...
  L.Control.BrowserPrint.Utils = {
    ...
    cloneBasicOptionsWithoutLayers: function (t) {
      var e = {}, r = Object.getOwnPropertyNames(t);
      if (r.length) {
    ...
    _register: function (t, e, r, n) {
      e && !t.filter(function (t) {
        ...
        type: e, identifier: r, builder: n || function (t) {
  ...
  L.Control.BrowserPrint = L.Control.extend({
    options: {
      ...
      printTitles: {"Portrait": "竖版", "Landscape": "横版", "Auto": "自动", "Custom": "自定义"},
      ...
      var e = this._getBoundsForAllVisualLayers(), r = this._getPageSizeFromBounds(e);
      this._print(this._getMode(r, t), e)
    }, _printCustom: function (t) {
      this._addPrintClassToContainer(this._map, "leaflet-browser-print--custom"), this.options.custom = {mode: t}, this._map.on("mousedown", this._startAutoPoligon, this)
      ...
      this._map.fire(L.Control.BrowserPrint.Event.PrintInit, {mode: t}), L.Control.BrowserPrint.Utils.initialize();
      var r = this, n = this._map.getContainer(), i = t.Mode, o = {
