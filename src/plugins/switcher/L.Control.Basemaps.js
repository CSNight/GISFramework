  ...
  onAdd: function (map) {
    ...
    this.options.basemaps.forEach(function (d, i) {
      ...
      if (d.options.iconURL) {
        ...
        if (d.options.hasOwnProperty("annotation")) {
          this.anno = L.tileLayer.chinaProvider(d.options.annotation, {
            maxZoom: (d.options.maxZoom ? d.options.maxZoom : 18),
            minZoom: (d.options.minZoom ? d.options.minZoom : 0)
          });
          this._map.addLayer(this.anno);
        }
